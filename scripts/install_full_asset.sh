...
echo "  2) Confirmar objeto de log Voice_Service_Reply__c e campos (Voice_Call__c, Search_Query__c, Answer_1__c, Answer_2__c, Feedback_Status__c, Feedback_Reasons__c, Feedback_At__c, Feedback_By__c)."
